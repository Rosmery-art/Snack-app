...
export default function Registro() {
  ...
  return (
    ...
    >
      ...
      <TextInput
        style={styles.input}
        placeholder="    Código    " // Texto de ejemplo
        keyboardType="codigo" // Teclado específico para email
        autoCapitalize="none" // Evitar capitalización automática
      />


<TouchableOpacity style={styles.button}
onPress={() => navigation.navigate('contraseña3')}>
        <Text style={styles.buttonText}>ENVIAR</Text>
      </TouchableOpacity>

      <Text style={styles.title}>Reenviar código</Text>
      </View>
    </ImageBackground>
  );
}
